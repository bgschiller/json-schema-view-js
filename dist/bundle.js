  ...
  */
  function JSONSchemaView(schema, open) {
    ...
    if (this.schema && Array.isArray(this.schema.required)) {
      Object(__WEBPACK_IMPORTED_MODULE_1__helpers_js__["c" /* forEachProperty */])(this.schema, function (property, name) {
  ...
  _createClass(JSONSchemaView, [{
    ...
    */
    ...
    value: function appendChildren(element) {
      ...
      if (this.schema.enum) {
        var formatter = new __WEBPACK_IMPORTED_MODULE_0_json_formatter_js___default.a(this.schema.enum, this.open - 1, this.options);
      ...
      if (_typeof(this.schema.properties) === 'object') {
        Object.keys(this.schema.properties).forEach(function (propertyName) {
          ...
          var view = new JSONSchemaView(property, _this2.open - 1, _this2.options);
...
function forEachProperty(schema, func) {
  var applyOnSchema = function applyOnSchema(s) {
    return forEachProperty(s, func);
  };
  if (schema.anyOf) {
